...
@section('content')
    ...
    <hr><br>
    <a href="#" class="btn btn-primary m-2">Record Your Daily Progress</a>
    ...
    <hr><br>
    <a href="{{ route('import-reps-get') }}" class="btn btn-info m-2">Import Reps Excel File</a>
    <hr><br>
    <a href="{{ route('rep-home') }}" class="btn btn-info m-2">Rep Home Page</a>
@endsection
